      ...
      ? [
          ...
          },
          {
            ...
            label: (
              <p
                className={`${
                  course.type === `online` ? `cursor-not-allowed` : ``
                }`}
                onClick={() => {
            ...
            label: (
              <p
                onClick={() => {
                  if (
                    isActionChecked(
                      "View Course Participant and send email reminder",
                      user.privileges
                    )
                  ) {
            ...
            label: (
              <p
                onClick={() => {
                  if (
                    isActionChecked(
                      "Add, delete and edit additional resources",
                      user.privileges
                    )
                  ) {
                    setResources(true);
    ...
    <div className="p-2 w-full shadow-md my-3 rounded-md bg-white">
      <div className="flex my-2">
        ...
        <p className="font-medium ml-3 text-sm">
          A course by {course.instructorName}
        </p>
      </div>
      ...
      <h3 className="font-medium my-3">
        ...
        {pathname.includes("courses") && pathname.includes("admin") ? (
          <Link href={`/admin/${course._id}?page=${course.type}`}>
            <button className="bg-primary p-2 rounded-md">{course.type}</button>{" "}
          </Link>
      ...
      <div className="flex justify-between my-3">
        <div>
          ...
          <div className="flex ml-1">
            {course.enrolledStudents.slice(0, 6).map((course) => (
              <img
                key={course._id}
                src={
            ...
            <div className="lg:p-10 p-4 text-center">
              ...
              <div>
                <div className="flex my-4 justify-center">
                  ...
                  <button onClick={() => setDelete(false)} className="mx-4">
                    Cancel
                  </button>
                </div>
              </div>
      ...
      {enrolled && (
        <div>
          ...
          <div className="fixed top-10 bottom-10 left-0 rounded-md right-0 lg:w-[30%] w-[90%] h-[50%] mx-auto z-20 bg-[#F8F7F4]">
            ...
            <div className="lg:p-10 p-4 text-center">
              <h1 className="text-2xl">
                You can't delete this course because someone has already
                enrolled!
              </h1>
              <div>
                <div className="flex my-4 justify-center">
