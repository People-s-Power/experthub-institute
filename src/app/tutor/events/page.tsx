...
const Events = () => {
  ...
  const getAllEvents = () => {
    apiService.get(`events/author/${user.id}`).then(function (response) {
  ...
  const filterItems: MenuProps["items"] = [
    {
      key: "all",
      label: <p onClick={() => filterEvents("all")}>All Events</p>,
    },
    {
      key: "conference",
      label: <p onClick={() => filterEvents("conference")}>Conference</p>,
    },
    {
      key: "seminar",
      label: <p onClick={() => filterEvents("seminar")}>Seminar</p>,
    },
    {
      key: "workshop",
      label: <p onClick={() => filterEvents("workshop")}>Workshop</p>,
    },
    {
      key: "webinar",
      label: <p onClick={() => filterEvents("webinar")}>Webinar</p>,
    },
  ];
